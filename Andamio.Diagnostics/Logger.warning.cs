...
namespace Andamio.Diagnostics
{
    ...
    public static partial class Logger
    {
        ...
        /// <param name="message">A message to output.</param>
        public static void Warning(string user, string message)
        {
        ...
        /// <param name="eventId">Represents an categorical Log Event.</param>        
        /// <param name="message">A message to output.</param>
        public static void Warning(string user, int eventId, string message)
        {
        ...
        /// <param name="message">A message to output.</param>
        /// <param name="e">An exception to output.</param>
        public static void Warning(string user, string message, Exception e)
        {
        ...
        /// <param name="message">A message to output.</param>
        /// <param name="e">An exception to output.</param>
        public static void Warning(int eventId, string message, Exception e)
        {
        ...
        /// <param name="message">A message to output.</param>
        /// <param name="e">An exception to output.</param>
        public static void Warning(string user, int eventId, string message, Exception e)
        {
            Log logger = Log.FromConfig();
            user = user.IsNullOrBlank() ? UserIdentity.GetIdentityName() : user;
        ...
        public static void Warning(string message, Exception e, params LogAttachment[] attachments)
        {
        ...
        /// <param name="e">An exception to output.</param>
        /// <param name="attachments">The list of KeyValuePair&lt;string, object&gt; to output.</param>
        public static void Warning(string user, string message, Exception e, params LogAttachment[] attachments)
        {
        ...
        /// <param name="e">An exception to output.</param>
        /// <param name="attachments">The list of KeyValuePair&lt;string, object&gt; to output.</param>
        public static void Warning(int eventId, string message, Exception e, params LogAttachment[] attachments)
        {
        ...
        /// <param name="e">An exception to output.</param>
        /// <param name="attachments">The list of KeyValuePair&lt;string, object&gt; to output.</param>
        public static void Warning(string user, int eventId, string message, Exception e, params LogAttachment[] attachments)
        {
            Log logger = Log.FromConfig();
            user = user.IsNullOrBlank() ? UserIdentity.GetIdentityName() : user;
