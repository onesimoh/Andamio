...
namespace Andamio.Diagnostics
{
    ...
    public partial class Log
    {
        ...
        /// <param name="eventId">Represents an categorical Log Event.</param>        
        /// <param name="message">A message to output.</param>
        public void Error(string user, int eventId, string message)
        {
        ...
        /// <param name="message">A message to output.</param>
        /// <param name="e">An exception to output.</param>
        public void Error(string user, string message, Exception e)
        {
        ...
        /// <param name="message">A message to output.</param>
        /// <param name="e">An exception to output.</param>
        public void Error(int eventId, string message, Exception e)
        {
        ...
        /// <param name="message">A message to output.</param>
        /// <param name="e">An exception to output.</param>
        public void Error(string user, int eventId, string message, Exception e)
        {
            user = user.IsNullOrBlank() ? UserIdentity.GetIdentityName() : user;
        ...
        public void Error(string message, Exception e, params LogAttachment[] attachments)
        {
        ...
        /// <param name="e">An exception to output.</param>
        /// <param name="attachments">The list of KeyValuePair&lt;string, object&gt; to output.</param>
        public void Error(string user, string message, Exception e, params LogAttachment[] attachments)
        {
        ...
        /// <param name="e">An exception to output.</param>
        /// <param name="attachments">The list of KeyValuePair&lt;string, object&gt; to output.</param>
        public void Error(int eventId, string message, Exception e, params LogAttachment[] attachments)
        {
        ...
        /// <param name="e">An exception to output.</param>
        /// <param name="attachments">The list of KeyValuePair&lt;string, object&gt; to output.</param>
        public void Error(string user, int eventId, string message, Exception e, params LogAttachment[] attachments)
        {
            user = user.IsNullOrBlank() ? UserIdentity.GetIdentityName() : user;
